...
protein_groups_filtered <- mq_prot_selected %>%
  filter(is.na(only_identified_by_site)) %>%  # remove proteins only identified by PTM, reverse hits and potential contaminants
