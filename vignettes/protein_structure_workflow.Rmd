...
The impressive thing about using `r3dmol` is that you can interact with the structure if this Vignette is an html document. You can for example zoom, rotate or move the structure.
