...
Before starting the structural analysis of your data you need to load **protti** and additional packages used for the analysis. As described on the [main page](https://jpquast.github.io/protti/index.html) of **protti**, the [tidyverse](https://tidyverse.org/) package collection works well together with the rest of the package, by design. You can load packages with the `library()` function.
