...
Before plotting your PCA you can check how much of your variance can be explained with each of the principle components. To do that you can plot a scree-plot using the function `qc_pca()` and setting `plot_style = "scree"`. In his example we can see that the variance can be best explained with PC1 and PC2 so we can go ahead and plot these.
