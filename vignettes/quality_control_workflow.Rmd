...
In general, there are several ways in which this can be done: 
  ...
  * R packages (e.g. [PTXQC](https://pubs.acs.org/doi/10.1021/acs.jproteome.5b00780) which runs on MaxQuant output or [rawDiag](https://pubs.acs.org/doi/10.1021/acs.jproteome.8b00173) which can be used directly on raw files) 
