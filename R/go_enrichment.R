...
#' @param go_annotations_uniprot (Recomended) The name of the column containing gene ontology annotations obtained from uniprot using \code{fetch_uniprot}. 
...
#' @param organism_id Optional, An NCBI taxonomy identifier of an organism (TaxId). Possible inputs inlude only: "9606" (Human), "559292" (Yeast) and 
...
#' type first followed by the theshold separated by a space. Example are \code{plot_cutoff = "adj_pval top10"}, \code{plot_cutoff = "pval 0.05"} 
#' or \code{plot_cutoff = "adj_pval 0.01"}. The threshold can be choosen freely.
#' 
...
#' plot cutoffs can be choosen individialy with the \code{plot_cutoff} argument. 
