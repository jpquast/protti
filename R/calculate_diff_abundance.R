...
#' be used to infer means across samples based on a probabilistic dropout model. This eliminates the need for data imputation since missing values are inferred from the
#' model. More information can be found in the \code{proDA} documentation. Default is \code{method = "moderated_t-test"}.
