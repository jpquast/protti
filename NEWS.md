...
* The `run_order` argument of `qc_sample_correlation()` not has a gradient colour scheme that is easier to interpret than distinct colours. The colours are inspired by the "plasma" colour scheme of the viridis package.
