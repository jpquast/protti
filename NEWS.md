...
* `calculate_aa_scores()` gained a `methods` argument, allowing user to choose between additive or multiplicative score caluclation mode. The function now returns min-max normalized scores in addition to raw values.
